/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+json+json5+jsonp&plugins=toolbar+copy-to-clipboard+download-button */
var _self =
    ...
    Prism = (function(e) {
                ...
                highlightElement: function(n, t, r) {
                    ...
                    if (
                        (a.hooks.run("before-sanity-check", s),
                            ...
                            o.setAttribute("tabindex", "0"), !s.code)
                    )
            ...
            for (var f in t)
                if (t.hasOwnProperty(f) && t[f]) {
                    ...
                    for (var d = 0; d < h.length; ++d) {
                        ...
                        for (
                            var b = v.pattern || v, w = r.next, A = s; w !== n.tail && !(g && A >= g.reach); A += w.value.length, w = w.next
                        ) {
                            var E = w.value;
                            ...
                            if (!(E instanceof i)) {
                                ...
                                if (y) {
                                    ...
                                    if (((A = j -= w.value.length), w.value instanceof i))
                                        continue;
                                    for (
                                        var C = w; C !== n.tail && (j < O || "string" == typeof C.value); C = C.next
                                    )
                                        L++, (j += C.value.length);
        ...
        if (
            (g &&
                ((a.filename = g.src),
                    g.hasAttribute("data-manual") && (a.manual = !0)), !a.manual)
        ) {
